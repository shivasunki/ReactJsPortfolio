...
export default function SideNav() {
  ...
  return (
    <div>
      ...
      {nav ? (
        <div className="fixed w-full h-screen flex flex-col justify-center items-center z-[20] bg-gray-300">
          <a onClick={handleNav}
            href="#main"
            className="w-[75%] flex justify-center items-center rounded-full m-2 p-4 shadow-lg bg-gray-100 shadow-gray-400 hover:scale-110 cursor-pointer ease-in duration-200"
          >
            <AiOutlineHome
              size={20}
